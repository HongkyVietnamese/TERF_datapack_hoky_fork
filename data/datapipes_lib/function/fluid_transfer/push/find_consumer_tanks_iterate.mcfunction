...
execute if score succeeded datapipes_lib matches 0 run function datapipes_lib:fluid_transfer/push/as_consumer_tank with storage datapipes_lib:temp array2[-1]

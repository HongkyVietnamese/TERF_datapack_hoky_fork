...
$execute store result entity @s data.fluids[{id:$(id),checks:'$(checks)'}].amount int 1 run scoreboard players operation tank_amount datapipes_lib < tank_max datapipes_lib

#set the item_name of the item display temp entity from its custom_data.fluids[0], if it dosent exist just set it to "Syringe"
execute unless data entity 0010ccd2-0010-cd37-0010-cd360010c8e1 item.components.minecraft:custom_data.fluids[0] run return run data modify entity 0010ccd2-0010-cd37-0010-cd360010c8e1 item.components.minecraft:item_name set value "Syringe"
